...
var WishToken = function () {
    ...
    LocalContractStorage.defineProperty(this, "adminAddress"); // 发币账户地址
    LocalContractStorage.defineProperty(this, "isFounding"); // 是否在募集资金阶段
};
...
WishToken.prototype = {
    ...
    // ------------------以上事NRC20货币的基本方法，以下实现一个可增发、可售卖的代币-----------------------------

    /// 增加货币供应量
    increaseSupply: function(value) {
    },
    
    // 减少货币供应量
    decreaseSupply: function(value) {
    },

    // 增加货币供应量
    startFounding: function() {
    ...
    withdraw: function(value) {
        ...
        var result = Blockchain.transfer(tthis.adminAddress, parseInt(value) * 1000000000000000000);
        if (!result) {
