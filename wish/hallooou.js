...
$(function () {
    $('.overlay-menu ul li a,.scroll-top a,.navbar-nav a,footer .link a').bind('click', function (event) {
		//$("[name='button']").attr('style','border-bottom:0px solid #E78338');
        var $anchor = $(this);
		//$anchor.attr('style','border-bottom:5px solid #E78338');
...
$(window).scroll(function(){
    if($(window).scrollTop()>1200){
        $("[name='button']").attr('style','border-bottom:0px solid #E78338');
        $("#button2").attr('style','border-bottom:2px solid #E78338');
    }

    if($(window).scrollTop()>1800){
        $("[name='button']").attr('style','border-bottom:0px solid #E78338');
        $("#button3").attr('style','border-bottom:2px solid #E78338');
    }
    if($(window).scrollTop()>2420){
        $("[name='button']").attr('style','border-bottom:0px solid #E78338');
        $("#button4").attr('style','border-bottom:2px solid #E78338');
    }
    if($(window).scrollTop()>2950){
        $("[name='button']").attr('style','border-bottom:0px solid #E78338');
        $("#button5").attr('style','border-bottom:2px solid #E78338');
    }
    if($(window).scrollTop()<1200){
        $("[name='button']").attr('style','border-bottom:0px solid #E78338');
        $("#button1").attr('style','border-bottom:2px solid #E78338');
    }
});
